...
Per il calcolo di $\sigma$ vogliamo implementare un metodo automatico che non richieda il tracciamento di ROI o una conoscenza a priori della geometria del fantoccio, quindi applicheremo un metodo automatico basato sull’analisi dell’istogramma di I_VAR.
