...
Le operazioni di filtraggio sull’immagine si possono classificare in tre categorie principali:
    ...
    Globali: Le operazioni globali operano sull’immagine nel suo complesso. Esempio di operazioni globali sono le operazioni sull’istogramma, come l’equalizzazione.
...
Esempi di trasformazioni puntuali sono (si consideri una immagine a 256 livelli): 
    ...
    il Windowing 
    le operazioni di tipo gamma u=v
